...
public class Main2 {
    ...
    public static void main(String[] args) {
        try{
        String password = "trustno1"; // パスワード(鍵の元)
        SecretKey key = generateKey(password); //暗号化　複合化の鍵(key)を作成

        
        // ファイル名
         String originalFile = "C:\\work\\java2025\\j0611\\onepiece02_zoro.png";               //暗号化される元のファイル
         String encryptedFile = "C:\\work\\java2025\\j0611\\onepiece02_zoro.enc.png";          //暗号化されたファイル名
         String decryptedFile = "C:\\work\\java2025\\j0611\\tonepiece02_zoro_decrypted.png";    //複合化された後のファイル名
